...
namespace TeamA.ToDo.EntityFramework.Migrations
{
    ...
    [Migration("20250412103420_FeatureManagementEntities")]
    partial class FeatureManagementEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpenseExpenseTag", b =>
                {
                    ...
                    b.ToTable("ExpenseExpenseTag", (string)null);
                });
            ...
            modelBuilder.Entity("TeamA.ToDo.Core.Models.Expenses.BudgetAlertSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime?>("LastSummarySent")
                        .HasColumnType("datetime2");

                    b.Property<bool>("SendMonthlySummary")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("TeamA.ToDo.Core.Models.FeatureManagement.FeatureDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TeamA.ToDo.Core.Models.FeatureManagement.RoleFeatureAccess", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("FeatureDefinitionId", "RoleId")
                        .IsUnique();

                    b.ToTable("RoleFeatureAccess");
                });

            modelBuilder.Entity("TeamA.ToDo.Core.Models.FeatureManagement.UserFeatureFlag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("FeatureDefinitionId", "UserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("TeamA.ToDo.Core.Models.FeatureManagement.RoleFeatureAccess", b =>
                {
                    b.HasOne("TeamA.ToDo.Core.Models.FeatureManagement.FeatureDefinition", "FeatureDefinition")
                        .WithMany("RoleFeatureAccess")
            ...
            modelBuilder.Entity("TeamA.ToDo.Core.Models.FeatureManagement.FeatureDefinition", b =>
                {
                    b.Navigation("RoleFeatureAccess");
