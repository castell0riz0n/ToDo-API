...
{
    /// <inheritdoc />
    public partial class AddExpenseTrackerEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpenseExpenseTag", x => new { x.ExpensesId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_ExpenseExpenseTag_ExpenseTags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "ExpenseTags",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ExpenseExpenseTag_Expenses_ExpensesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextProcessingDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CustomCronExpression = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExpenseRecurrences_Expenses_ExpenseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseExpenseTag_TagsId",
                table: "ExpenseExpenseTag",
                column: "TagsId");

            migrationBuilder.CreateIndex(
                name: "IX_ExpenseRecurrences_ExpenseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseTags_UserId_Name",
                table: "ExpenseTags",
                columns: new[] { "UserId", "Name" },
                unique: true);
